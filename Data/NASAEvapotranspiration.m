...
e_s_Tmax = 0.6108 * exp((17.27 * Tmax) ./ (Tmax + 237.3));  % Correct
e_s_Tmin = 0.6108 * exp((17.27 * Tmin) ./ (Tmin + 237.3));  % Correct
e_s = (e_s_Tmax + e_s_Tmin) / 2;  % Correct
...
Rns = (1 - alpha) * Rs_MJ;  % Rayonnement net ondes courtes (MJ/m?/jour)
...
ETo = max(ETo, 0);  % Eviter les valeurs negatives
